...
export class MutableSelectionSet {
  ...
  static empty(parentType: CompositeType): MutableSelectionSet {
    return new MutableSelectionSet(
      parentType,
      new SelectionSetUpdates(),
    );
  }

  static of(selectionSet: SelectionSet): MutableSelectionSet {
    const s = new MutableSelectionSet(selectionSet.parentType, new SelectionSetUpdates());
  ...
  clone(): MutableSelectionSet {
    return new MutableSelectionSet(this.parentType, this._updates.clone());
  }

  rebaseOn(parentType: CompositeType): MutableSelectionSet {
    const rebased = new MutableSelectionSet(parentType, new SelectionSetUpdates());
